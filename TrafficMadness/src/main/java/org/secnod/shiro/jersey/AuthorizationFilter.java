...
import org.trafficmadness.www.annotation.handlers.AdministratorAnnotationHandler;
import org.trafficmadness.www.annotation.handlers.NormalUserAnnotationHandler;
...
public class AuthorizationFilter implements ContainerRequestFilter {
    ...
    private static AuthorizingAnnotationHandler createHandler(Annotation annotation) {
        ...
        else if (RequiresNormalUser.class.equals(t)) return new NormalUserAnnotationHandler();
        else if (RequiresAdministrator.class.equals(t)) return new AdministratorAnnotationHandler();
